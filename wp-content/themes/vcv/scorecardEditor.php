...
<? $scorecardYears = get_terms( 'scorecard', array(    'hide_empty' => false,) );foreach($scorecardYears as $v){			$name=$v->name;		echo "<option>$name</option>";		}	?></select><input type='submit' value='GO'></form>
	...
	<section class='scorecard' data-year='<? echo $currentYear; ?>' >
		<h2>House</h2>
		<?
