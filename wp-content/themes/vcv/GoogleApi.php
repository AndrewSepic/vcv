					...
					if ( $query->have_posts() ) {
						...
						while ( $query->have_posts() ) {
							...
							<article class='searchResult clearfix'>
								...
								<div class='copy'>
									<h3><a href='<?  the_permalink(); ?>'  data-id='<? the_id();  ?>' data-email='<? the_field('email'); ?>' data-facebook='<? the_field('facebook_id'); ?>' data-phone='<? the_field('phones'); ?>'><? the_title(); ?></a></h3>
										<? if ($chamber=="Senate"): ?>
										<p>
										...
										<? } ?>
										<span class='towns'><strong>District: </strong><? the_field('towns'); ?></span>
									</p>
									<? else: ?>
									<p>
										<span class='party'><? echo substr(get_field('party'),0,1); ?></span>
										...
										if( get_field('second_party')  && get_field('second_party') !="null"){ ?>
											<span class='party second'><? echo substr(get_field('second_party'),0,1); ?></span>
										<? } ?>
										<span class='towns'><strong>District: </strong><? echo get_district(get_the_id()); ?></span> <em style='font-size:.8em;'>&ndash; <? the_field('towns'); ?></em>
									</p>
						...
						while ( $query->have_posts() ) {
							...
							<article class='searchResult clearfix'>
								...
								<div class='copy'>
									...
									?>
									<h3><a href='<?  the_permalink(); ?>' data-id='<? the_id();  ?>' data-email='<? the_field('email'); ?>' data-facebook='<? the_field('facebook_id'); ?>' data-phone='<?  echo $phone[0]; ?>'><? the_title(); ?></a></h3>
									<? if ($chamber=="Senate"): ?>
										<p>
										<span class='party'><? echo substr(get_field('party'),0,1); ?></span>
										<?
									...
									<p>
										...
										<span class='towns'><strong>District: </strong><? echo get_district(get_the_id()); ?></span>
										<em style='font-size:.8em;'>&ndash; <? the_field('towns'); ?></em>
									</p>
