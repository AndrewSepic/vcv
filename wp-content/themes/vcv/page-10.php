...
<script src="<? echo get_template_directory_uri(); ?>/js/tablesorter-master/jquery.tablesorter.min.js"></script>
	<section id='pageBanner'>
		<div  class='inner container'><h1 ><? the_title(); ?></h1></div>		
		</section>
    <section id='content' class='container clearfix'>
		<nav class='scoreboard'>
			...
			<h4 class='yearLabel'><? echo $year; ?></h4>
		</nav>
...
PREVIOUS SCORECARDS</p>
				<? the_field("pastScoreBoard") ?>
				</nav>
		</div>  
		
		
		<div id='senateTab' class='tabbed senate'>
			<? printScoreCard("Senate",$year,$year); ?>
		</div>
		<div id='houseTab' class='tabbed house'>
			<?  printScoreCard("House",$year,$year); ?> 
		</div>
