...
if( have_rows('slideshow') ):
	...
	?>
	<div class='slide' style="background-image: url(<? echo $img["url"]; ?>)">
		<div class='table' style="<?  //echo $offset;  ?>">
	    <div class='container '>
        <? 
...
?>
    ...
    <section id="icons">
    	<div class='container '>
				...
				<div class='intro'><? the_field("leader_intro"); ?></div>
				<div class='clearfix'>
<?php
...
?>
		<div class='feature'>
		 	<a href='<? the_sub_field("link"); ?>' class='imgHolder'><img src="<? echo $src;  ?>" height='70' /></a>
...
?>
    ...
    <section id="ourWork">
		<div class='container '>
	        ...
	        <h2>
	            ...
	            <? the_field('our_work_title'); ?>
	            <span class='line'></span>
	        </h2>
	        
	        <? the_field('our_work_content'); ?>
	        
	        <div id='buttons'>
	            <a href='<?  the_field('button_1_Link'); ?>'><? the_field('button_1_text'); ?></a>
	            <a href='<?  the_field('button_2_link'); ?>'><? the_field('button_2_text'); ?></a>
	        </div>
    ...
    <section id="coreIssues">
    	<div class='container '>
	        ...
	        <h2>
	            <span class='line'></span><? the_field("core_issues_title"); ?><span class='line'></span>
	        </h2>
	        
	        <div class='intro'><?  the_field('core_issues_text'); ?></div>
...
?>
		<div class='feature'>
		 	<div class='icon_circle_holder'><div class='img'><a href='<?  the_sub_field('link');  ?>'><img src="<? echo $src;  ?>" height='70' /></a></div></div>
		   	<p><?  the_sub_field('text'); ?></p>
		  </div>
<?
    endwhile; 
